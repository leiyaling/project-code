#ifndef _SETTINGS_I_SETTINGS_H
#define _SETTINGS_I_SETTINGS_H
#include "common.h"
...
namespace rededa
{
  class REDEDA_SETTINGS_API IRSettings
  {
  public:
    virtual ~IRSettings() = default;

    /**
     * @brief 获取settings产品枚举值
     *
     * @return SettingsProduct
     */
    virtual SettingsProduct getProduct() const = 0;
     ...
     * @return rhandle_t
     */
    virtual rhandle_t getHandle() const = 0;
     ...
     */
    virtual int updateValue(const std::string &aKey, const nlohmann::json &aJson) = 0;
     ...
     * @return int 返回操作结果，0表示成功，-1表示失败
     */
    virtual int insertValue(const std::string &aKey, const nlohmann::json &aJson) = 0;
     ...
     * @return int 返回操作结果，0表示成功，-1表示失败
     */
    virtual int deleteKey(const std::string &aKey) = 0;
     ...
     */
    virtual const std::string getValue(const std::string &aKey) = 0;
     ...
     * @return int 返回操作结果，0表示成功，-1表示失败
     */
    virtual int setAllData(const std::string &aData) = 0;
     ...
     */
    virtual void setISettingsDAO(std::shared_ptr<IRSettingsDAO> aSettingsDAO) = 0;

    /**
     * @brief 设置回调函数
     * @param aData 通知VM数据变化的回调函数
     */
    virtual void setChangeCallBack(const data_change_call_back aCallBack) = 0;
     ...
     */
    virtual void attach(std::shared_ptr<IRSettingsObserver> aObserver) = 0;
     ...
     */
    virtual void detach(std::shared_ptr<IRSettingsObserver> aObserver) = 0;
     ...
     */
    virtual void notify(const std::string &aKey, const nlohmann::json &aValue) = 0;
     ...
     */
    virtual void notifyAll(const nlohmann::json &aData) = 0;
  };

}

#endif /* _SETTINGS_I_SETTINGS_H */
