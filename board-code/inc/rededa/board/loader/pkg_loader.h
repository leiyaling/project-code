#ifndef INCLUDE_BOARD_LOADER_PKGLOADER
#define INCLUDE_BOARD_LOADER_PKGLOADER
#include <filesystem>
#include <fstream>
#include <memory>
#include "project_manager/inc/i_design_loader.h"

namespace rededa
{
class RPkgLoader : public RIDesignLoader
{
  private:
    /**
     * @brief 路径合法性检查
...
#endif // INCLUDE_BOARD_LOADER_PKGLOADER